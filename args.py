...
#huimin
	parser.add_argument(
		 "--data_path",
		type=str,
		default='prepare_data/data/demo/images',
		 help="Path to the directory of the images for demo.")
	parser.add_argument(
		 "--depth_path",
		type=str,
		default='prepare_data/data/demo/depth',
		 help="Path to the directory of the depth data for demo.")
